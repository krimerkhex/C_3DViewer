#############################################################################
# Makefile for building: 3DViewer.app/Contents/MacOS/3DViewer
# Generated by qmake (3.1) (Qt 6.2.3)
# Project:  GUI/3DViewer.pro
# Template: app
# Command: /usr/local/Cellar/qt/6.2.3/bin/qmake6 -o Makefile GUI/3DViewer.pro -spec macx-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CFLAGS        = -pipe -g -std=gnu11 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk -mmacosx-version-min=11 -Wall -Wextra -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 3DViewer1.0.0
DISTDIR = /Users/hashtagr/Desktop/3/src/.tmp/3DViewer1.0.0
...
SOURCES       = c-part/backend.c \
		c-part/memory_work.c \
		c-part/parce_f.c \
		c-part/parce_v.c \
		c-part/rotation.c \
		GUI/gifimage/dgif_lib.c \
		GUI/gifimage/egif_lib.c \
		GUI/gifimage/gif_err.c \
		GUI/gifimage/gif_font.c \
		GUI/gifimage/gif_hash.c \
		GUI/gifimage/gifalloc.c \
		GUI/gifimage/qgifimage.cpp \
		GUI/gifimage/quantize.c \
		GUI/graphicwindow.cpp \
		GUI/main.cpp \
...
OBJECTS       = backend.o \
		...
		mainwindow.o \
		moc_mainwindow.o
DIST          = GUI/gifimage/doc/qtgifimage.qdocconf \
		GUI/gifimage/doc/src/examples.qdoc \
		GUI/gifimage/doc/src/index.qdoc \
		GUI/gifimage/doc/src/qtgifimage.qdoc \
		GUI/gifimage/doc/src/usage.qdoc \
		GUI/gifimage/giflib/AUTHORS \
		GUI/gifimage/giflib/COPYING \
		GUI/gifimage/giflib/README \
		GUI/gifimage/qtgifimage.pri \
		...
		GUI/GUI/3DViewer.pro c-part/backend.h \
		GUI/gifimage/gif_hash.h \
		GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h \
		GUI/gifimage/qgifglobal.h \
		GUI/gifimage/qgifimage.h \
		GUI/gifimage/qgifimage_p.h \
		GUI/graphicwindow.h \
		GUI/mainwindow.h c-part/backend.c \
		c-part/memory_work.c \
		c-part/parce_f.c \
		c-part/parce_v.c \
		c-part/rotation.c \
		...
		GUI/main.cpp \
		GUI/mainwindow.cpp
QMAKE_TARGET  = 3DViewer
DESTDIR       = 
TARGET        = 3DViewer.app/Contents/MacOS/3DViewer
...
EXPORT__PRO_FILE_ = /Users/hashtagr/Desktop/3/src/GUI/3DViewer.pro
...
3DViewer.app/Contents/MacOS/3DViewer: ui_mainwindow.h $(OBJECTS)  
	@test -d 3DViewer.app/Contents/MacOS/ || mkdir -p 3DViewer.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: GUI/3DViewer.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/share/qt/mkspecs/common/unix.conf \
		/usr/local/share/qt/mkspecs/common/mac.conf \
		/usr/local/share/qt/mkspecs/common/macx.conf \
	 ...
	 $(QMAKE) -o Makefile GUI/3DViewer.pro -spec macx-clang CONFIG+=debug CONFIG+=qml_debug
/usr/local/share/qt/mkspecs/features/spec_pre.prf:
/usr/local/share/qt/mkspecs/features/device_config.prf:
/usr/local/share/qt/mkspecs/common/unix.conf:
/usr/local/share/qt/mkspecs/common/mac.conf:
...
3DViewer.app/Contents/PkgInfo: 
	@test -d 3DViewer.app/Contents || mkdir -p 3DViewer.app/Contents
	@$(DEL_FILE) 3DViewer.app/Contents/PkgInfo
	@echo "APPL????" > 3DViewer.app/Contents/PkgInfo
3DViewer.app/Contents/Resources/empty.lproj: 
	@test -d 3DViewer.app/Contents/Resources || mkdir -p 3DViewer.app/Contents/Resources
	@touch 3DViewer.app/Contents/Resources/empty.lproj
	
3DViewer.app/Contents/Info.plist: 
	@test -d 3DViewer.app/Contents || mkdir -p 3DViewer.app/Contents
	@$(DEL_FILE) 3DViewer.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.3DViewer,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.3DViewer,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,icon.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},icon.icns,g" -e "s,@EXECUTABLE@,3DViewer,g" -e "s,@LIBRARY@,3DViewer,g" -e "s,\$${EXECUTABLE_NAME},3DViewer,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >3DViewer.app/Contents/Info.plist
3DViewer.app/Contents/Resources/icon.icns: GUI/img/icon.icns
	@test -d 3DViewer.app/Contents/Resources/ || mkdir -p 3DViewer.app/Contents/Resources/
	@$(DEL_FILE) 3DViewer.app/Contents/Resources/icon.icns
	@$(COPY_FILE) GUI/img/icon.icns 3DViewer.app/Contents/Resources/icon.icns

all: Makefile \
		3DViewer.app/Contents/PkgInfo \
		3DViewer.app/Contents/Resources/empty.lproj \
		3DViewer.app/Contents/Info.plist \
		3DViewer.app/Contents/Resources/icon.icns 3DViewer.app/Contents/MacOS/3DViewer
...
distdir: FORCE
	...
	$(COPY_FILE) --parents c-part/backend.h GUI/gifimage/gif_hash.h GUI/gifimage/gif_lib.h GUI/gifimage/gif_lib_private.h GUI/gifimage/qgifglobal.h GUI/gifimage/qgifimage.h GUI/gifimage/qgifimage_p.h GUI/graphicwindow.h GUI/mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents c-part/backend.c c-part/memory_work.c c-part/parce_f.c c-part/parce_v.c c-part/rotation.c GUI/gifimage/dgif_lib.c GUI/gifimage/egif_lib.c GUI/gifimage/gif_err.c GUI/gifimage/gif_font.c GUI/gifimage/gif_hash.c GUI/gifimage/gifalloc.c GUI/gifimage/qgifimage.cpp GUI/gifimage/quantize.c GUI/graphicwindow.cpp GUI/main.cpp GUI/mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents GUI/mainwindow.ui $(DISTDIR)/


clean: compiler_clean clean_lib clean_obj clean_test
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) *~ core *.core


distclean: clean 
	-$(DEL_FILE) -r 3DViewer.app
	# -$(DEL_FILE) Makefile
...
moc_mainwindow.cpp: GUI/mainwindow.h \
		...
		/usr/local/lib/QtGui.framework/Headers/QPointerEvent \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/hashtagr/Desktop/3/src/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/hashtagr/Desktop/3/src/GUI -I/usr/local/lib/QtOpenGLWidgets.framework/Headers -I/usr/local/lib/QtOpenGL.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/usr/local/lib GUI/mainwindow.h -o moc_mainwindow.cpp
...
ui_mainwindow.h: GUI/mainwindow.ui \
		...
		/usr/local/lib/QtWidgets.framework/Headers/qwidget.h \
		c-part/backend.h
	/usr/local/share/qt/libexec/uic GUI/mainwindow.ui -o ui_mainwindow.h
...
backend.o: c-part/backend.c c-part/backend.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o backend.o c-part/backend.c

memory_work.o: c-part/memory_work.c c-part/backend.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o memory_work.o c-part/memory_work.c

parce_f.o: c-part/parce_f.c c-part/backend.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o parce_f.o c-part/parce_f.c

parce_v.o: c-part/parce_v.c c-part/backend.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o parce_v.o c-part/parce_v.c

rotation.o: c-part/rotation.c c-part/backend.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o rotation.o c-part/rotation.c

dgif_lib.o: GUI/gifimage/dgif_lib.c GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h \
		GUI/gifimage/gif_hash.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o dgif_lib.o GUI/gifimage/dgif_lib.c

egif_lib.o: GUI/gifimage/egif_lib.c GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h \
		GUI/gifimage/gif_hash.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o egif_lib.o GUI/gifimage/egif_lib.c

gif_err.o: GUI/gifimage/gif_err.c GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h \
		GUI/gifimage/gif_hash.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o gif_err.o GUI/gifimage/gif_err.c

gif_font.o: GUI/gifimage/gif_font.c GUI/gifimage/gif_lib.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o gif_font.o GUI/gifimage/gif_font.c

gif_hash.o: GUI/gifimage/gif_hash.c GUI/gifimage/gif_hash.h \
		GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o gif_hash.o GUI/gifimage/gif_hash.c

gifalloc.o: GUI/gifimage/gifalloc.c GUI/gifimage/gif_lib.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o gifalloc.o GUI/gifimage/gifalloc.c

qgifimage.o: GUI/gifimage/qgifimage.cpp GUI/gifimage/qgifimage.h \
		GUI/gifimage/qgifglobal.h \
		/usr/local/lib/QtCore.framework/Headers/QtGlobal \
		/usr/local/lib/QtCore.framework/Headers/qglobal.h \
		/usr/local/lib/QtGui.framework/Headers/QColor \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qgifimage.o GUI/gifimage/qgifimage.cpp

quantize.o: GUI/gifimage/quantize.c GUI/gifimage/gif_lib.h \
		GUI/gifimage/gif_lib_private.h \
		GUI/gifimage/gif_hash.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o quantize.o GUI/gifimage/quantize.c

graphicwindow.o: GUI/graphicwindow.cpp GUI/graphicwindow.h \
		/usr/local/lib/QtWidgets.framework/Headers/QColorDialog \
		/usr/local/lib/QtWidgets.framework/Headers/qcolordialog.h \
		/usr/local/lib/QtCore.framework/Headers/QDebug \
		/usr/local/lib/QtCore.framework/Headers/qdebug.h \
		...
		/usr/local/lib/QtWidgets.framework/Headers/qwidget.h \
		c-part/backend.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o graphicwindow.o GUI/graphicwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/3DViewer/bin || mkdir -p $(INSTALL_ROOT)/opt/3DViewer/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/3DViewer/bin/3DViewer.app
	
	$(QINSTALL) 3DViewer.app $(INSTALL_ROOT)/opt/3DViewer/bin/3DViewer.app

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/3DViewer/bin/3DViewer.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/3DViewer/bin/ 
...
gcov_report: clean_test clean_lib
	gcc -Wall -Wextra -Werror -std=c11 -fprofile-arcs -ftest-coverage c-part/backend.c c-part/memory_work.c c-part/parce_f.c c-part/parce_v.c c-part/rotation.c c-part/unit_test.c -o unit_test -lcheck
	./unit_test
...
test:
	gcc c-part/backend.c c-part/memory_work.c c-part/parce_f.c c-part/parce_v.c c-part/rotation.c c-part/unit_test.c -o unit_test -lcheck
	./unit_test
